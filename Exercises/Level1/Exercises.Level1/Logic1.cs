...
namespace Exercises.Level1
{
    ...
    public class Logic1
    {
        ...
        {
            if (!isAsleep && (!isMorning  || (isMorning && isMom)))
            {
                return true;
            }
            return false;
        ...
        {
            int l = str.Length-1;
            if (str.Substring(0,1)=="f" && str.Substring(l,1)=="b")
            {
                return "FizzBuzz";
            }
